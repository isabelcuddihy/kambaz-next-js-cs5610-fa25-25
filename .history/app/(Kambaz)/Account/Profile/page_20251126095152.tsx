   ...
   <div className="wd-profile-screen">
     ...
     {profile && (
       <div>
        ...
        <FormControl id="wd-id" className="mb-2"
           value={profile.id || ""}
           onChange={(e) => setProfile({ ...profile, id: e.target.value })} />
            <FormControl id="wd-loginId" className="mb-2"
           value={profile.loginId || ""}
           onChange={(e) => setProfile({ ...profile, loginId: e.target.value })} />
            <FormControl id="wd-section" className="mb-2"
           value={profile.section || ""}
           onChange={(e) => setProfile({ ...profile, section: e.target.value })} />
            <FormControl id="wd-lastActivity" className="mb-2"
           value={profile.lastActivity || ""}
           onChange={(e) => setProfile({ ...profile, lastActivity: e.target.value })} />
            <FormControl id="wd-totalActivity" className="mb-2"
           value={profile.totalActivity || ""}
           onChange={(e) => setProfile({ ...profile, totalActivity: e.target.value })} />
